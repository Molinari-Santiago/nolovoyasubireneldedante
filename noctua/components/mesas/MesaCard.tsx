...
export const MesaCard = memo(function MesaCard({ mesa, isSelected, onSingleClick, onDoubleClick }: MesaCardProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        colorClass,
        isSelected ? 'border-white ring-2 ring-white ring-offset-2 ring-offset-black' : 'border-transparent',
    ...
    >
      ...
      {elapsed && (
        <div className={cn(
          ...
          <Clock size={9} />
          <span className="text-[10px] font-mono font-semibold">{elapsed}</span>
        </div>
      )}
